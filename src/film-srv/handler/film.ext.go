...
import (
	...
	errors "movie/src/share/errors"
	"movie/src/share/pb"
	"movie/src/share/utils/common"
...
// 正在售票列表
func (f *FilmServiceExtHandler) HotPlayMovies(ctx context.Context, req *pb.HotPlayMoviesReq, rsp *pb.HotPlayMoviesRsp) error {
...
// 电影详情
func (f *FilmServiceExtHandler) MovieDetail(ctx context.Context, req *pb.MovieDetailReq, rsp *pb.MovieDetailRsp) error {
...
// 获取演员和导演信息
func (f *FilmServiceExtHandler) MovieCreditsWithTypes(ctx context.Context, req *pb.MovieCreditsWithTypesReq, rsp *pb.MovieCreditsWithTypesRsp) error {
...
// 获取剧照信息
func (f *FilmServiceExtHandler) ImageAll(ctx context.Context, req *pb.ImageAllReq, rsp *pb.ImageAllRsp) error {
...
// LocationMovies 即将上映的影片
func (f *FilmServiceExtHandler) LocationMovies(ctx context.Context, req *pb.LocationMoviesReq, rsp *pb.LocationMoviesRsp) error {
...
// 即将上映的影片
func (f *FilmServiceExtHandler) MovieComingNew(ctx context.Context, req *pb.MovieComingNewReq, rsp *pb.MovieComingNewRsp) error {
...
// GetFilmsByCidADay 根据影院id和时间获取正在销售的影片信息
...
// 搜搜出来的影片信息
func (f *FilmServiceExtHandler) Search(ctx context.Context, req *pb.SearchReq, rsp *pb.SearchRsp) error {
